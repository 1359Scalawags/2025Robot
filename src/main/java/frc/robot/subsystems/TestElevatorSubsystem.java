...
public class TestElevatorSubsystem extends SubsystemBase {
    ...
    public TestElevatorSubsystem(TestArmSubsystem armSubsystem) {
        ...
        configureElevatorSparkMax();

        // create simulated elevator and mechanism display
        elevatorSim = new ElevatorSim(elevatorDCMotorNeo, 
                                Constants.TestElevator.kGearRatio, 
                                Constants.TestElevator.kCarriageMassKg, 
                                Constants.TestElevator.kSpindleRadiusMeters, 
    ...
    public void initializeEncoders() {
        ...
        System.out.println("Elevator: " + elevatorSim.getPositionMeters());
    }

    public void configureElevatorSparkMax() {
    ...
    public void move(double elevatorDelta) {
