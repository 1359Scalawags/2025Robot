...
public class AimingAndRanging extends Command {
     ...
     * @param isOpenLoop
     */
    public AimingAndRanging(SwerveSubsystem swerve, DoubleSupplier vX, DoubleSupplier vY, DoubleSupplier omega, DoubleSupplier throttle, BooleanSupplier feildRelitive, boolean isOpenLoop) {
        this.swerve = swerve;
        this.vX = vX;
        this.vY = vY;
        this.omega = omega;
    ...
    public void execute() {
        ...
        if(swerve.isReversed()) {
            // if(feildRelitive.getAsBoolean()) {
                ...
                swerve.drive(
                    new Translation2d(vision.limelight_aim_proportional() , 0),
