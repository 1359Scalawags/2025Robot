...
public class AlignToReefTagRelative extends Command {
  ...
  public AlignToReefTagRelative(boolean isRightScore, SwerveSubsystem drivebase) {
    xController = new PIDController(Constants.SwerveSubsystem.X_REEF_ALIGNMENT_P, 0.0, 0);  // Vertical movement
    yController = new PIDController(Constants.SwerveSubsystem.Y_REEF_ALIGNMENT_P, 0.0, 0);  // Horitontal movement
    rotController = new PIDController(Constants.SwerveSubsystem.ROT_REEF_ALIGNMENT_P, 0, 0);  // Rotation
  ...
  public void initialize() {
    ...
    xController.setSetpoint(Constants.SwerveSubsystem.X_SETPOINT_REEF_ALIGNMENT);
    xController.setTolerance(Constants.SwerveSubsystem.X_TOLERANCE_REEF_ALIGNMENT);
  ...
  public boolean isFinished() {
    ...
    return this.dontSeeTagTimer.hasElapsed(Constants.SwerveSubsystem.DONT_SEE_TAG_WAIT_TIME) ||
        stopTimer.hasElapsed(Constants.SwerveSubsystem.POSE_VALIDATION_TIME);
  }
}